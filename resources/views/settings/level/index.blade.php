<x-app-layout>
  ...
  <div class="py-4 sm:py-12">
    <div class="mx-auto max-w-2xl px-2">
      <div hx-target="#levels-index" hx-swap="innerHTML" hx-get="{{ route('settings.level.index') }}" hx-trigger="loadLevels from:body" class="overflow-hidden bg-white dark:bg-gray-800 rounded sm:rounded-lg p-1">
